...
퀄리티가 높은 사진은 프로젝트의 질을 한층 더 높여줍니다. 하지만 과도한 사진 사용은 포트폴리오의 건강(?) 상당한 해를 끼칠 수 있기 때문에 필자는 사진 사용을 꺼려합니다. 그리고 사진 쓰면 랜딩 시간이 길어져... 그래서 짜증나!! 그리고 조별 포트폴리오 제작할 때 메인 페이지는 사진, 동영상 덕지덕지... 제가 했지만 너무 없어보여! 그 이후로 사진 잘 쓰지 않게 되었습니다. ~~Nyan Baseball은 배경 자체가 사진인데?~~ <-디자인 할 시간이 없었거든? ㅋㅋㅋ
